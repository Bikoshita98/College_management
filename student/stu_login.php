        ...
        <form name="form1" action="" method="post">
            ...
            <div class="separator">
                <p class="change_link">New to site?
                    <a href="stu_registration.php"> Create Account </a>
                </p>
	...
	<?php
		if(isset($_POST["submit1"])){
			...
			if(empty($Username) || empty($Password) ){
				$_SESSION["ErrorMessage"]= "Fields must be filled out";
				
				
				Redirect_to("stu_login.php");
								...
								if($found=mysqli_fetch_assoc($query_run)){
