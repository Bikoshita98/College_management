                ...
                <div class="row" style="min-height:500px">
					...
					<?php if(isset($_POST['submit1']))
							...
							<?php
									...
									$ViewQuery=("SELECT * FROM librarian_reg where username='$ProfileName'");
							...
							?>	
								...
								<tr><img src="Upload/<?php echo $Image; ?>" width="130px" height="130px" style="margin-left:40%;" ></tr><br><br><br>
								<tr><h4><b>	Username:&nbsp </b><?php echo $Username; ?> </h4>	</tr>
								<tr><h4><b>	Name: &nbsp </b><?php echo $Name2; ?>	</h4></tr>
								<tr><h4><b>	Contact: &nbsp </b><?php echo $Contact; ?>	</h4></tr>
								<tr><h4><b>	Email: &nbsp </b><?php echo $Email; ?>	</h4></tr>
