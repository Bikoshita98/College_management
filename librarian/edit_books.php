...
<?php require_once "include/functions.php";	?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div>
							...
							while($Datarows=mysqli_fetch_array($Execute)){
								...
								$AvailableToBeUpdated=$Datarows['quantity_available'];
							...
							<form action="Edit_book_info.php?Edit=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
								<fieldset>
									...
									<img src="Upload/<?php echo $ImageToBeUpdated; ?>" width=200px>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="BookName" id="bookname" placeholder="Name of the book" value="<?php $TitleToBeUpdated ?>">
									</div><br>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="Author" id="author" placeholder="Name of the Author" value="<?php $AuthorToBeUpdated ?>">
									</div><br>
									
									<div class="form-group">
										<label for="publication">Publication House:</label>
										<input class="form-control" type="text" name="Publication" id="publication" placeholder="Name of the Publication House" value="<?php $PublicationToBeUpdated ?>">
									</div><br>
									
									<div class="form-group">
										<label for="date">Purchase Date:</label>
										<input class="form-control" type="date" name="Date" id="date" value="<?php $DateToBeUpdated ?>" >
									</div><br>
									
									<div class="form-group">
										<label for="price">Price:</label>
										<input class="form-control" type="rupees" name="Price" id="price" placeholder="Price of the book" value="<?php $PriceToBeUpdated ?>">
									</div><br>
									...
									<div class="form-group">
										...
										<input class="form-control" type="text" name="Total" id="total" placeholder="Total number of books purchased" value="<?php $TotalToBeUpdated ?>" >
									</div><br>
									
									<div class="form-group">
										<label for="available">Available Quantity:</label>
										<input class="form-control" type="text" name="Available" id="available" placeholder="Available right now" value="<?php $AvailableToBeUpdated ?>" >
									</div><br>
		...
		if(isset($_POST["submit1"]))
		{
			...
			$Username=$_SESSION['username'];
				...
				$query="update add_books set datetime='$DateTime',book_img='$Image',book_name='$Title',author='$Author',publication='$Publication',purchase_date='$PurchaseDate',price='$Price',quantity_bought='$TotalBought',quantity_available='$Available','$_SESSION[librarian]')";
				$Execute=mysqli_query($connection,$query);
