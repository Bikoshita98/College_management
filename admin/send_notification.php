...
require_once "include/db.php";
 ...
 ?>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
							...
							$DateTime="";
							$Status="";
							$query=mysqli_query($connection,"select * from messages order by datetime desc");
		...
		if(isset($_POST["submit1"]))
		{
			...
			$DateTime;
			$res=mysqli_query($connection,"insert into messages values('','$_SESSION[librarian]','$_POST[dusername]','$_POST[title]','$_POST[msg]','$DateTime','no')");
